...
for file_i in range(len(pp_files)):
  ...
  npy_file = f'{paths.npy}/{pp_file[-11:-3]}.npy'
  is_complete = True
  ...
  if not os.path.exists(npy_file):
    ...
    for i in range(len(day)):
      ...
      if field.size == n_samples:   
        ...
        print(f'Missing data in {pp_file}.\nSkipping this day file for now. Try downloading it again.')
        missing.append(pp_file)
        is_complete = False
        break
